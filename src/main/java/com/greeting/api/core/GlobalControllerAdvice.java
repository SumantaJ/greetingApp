package com.greeting.api.core;

import static com.greeting.api.constants.Constants.MESSAGE_UNRECOGNIZED_PROPERTY;
import static com.greeting.api.core.validation.BeanValidationUtils.OBJECT_ERROR_DELIMITER;
...
import com.greeting.api.core.creation.EntityCreatedResponse;
import com.greeting.api.core.deletion.NoContentResponse;
import com.greeting.api.core.domain.ApiMessage;
import com.greeting.api.core.domain.ValidationErrorMessage;
import com.greeting.api.core.exception.BadRequestException;
import com.greeting.api.core.exception.EntityValidationException;
import com.greeting.api.core.exception.ResourceNotAccessibleException;
import com.greeting.api.core.exception.ResourceNotFoundException;
import com.greeting.api.core.exception.ServiceUnavailableException;
import com.greeting.api.core.exception.UnsupportedMediaTypeException;
import com.greeting.api.core.exception.UserAgentRequiredException;
